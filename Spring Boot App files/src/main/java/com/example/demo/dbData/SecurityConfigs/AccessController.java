...
import com.example.demo.dbData.FavoriteVehiclesRepository;
import com.example.demo.dbData.User;
import com.example.demo.dbData.UserRepository;
import com.example.demo.dbData.orderCarService.CarOrdersEntity;
import com.example.demo.dbData.orderCarService.CarOrdersRepository;
...
public class AccessController {
    ...
    private ModelAndView checkAccess(String pageUrl, String car, HttpServletRequest request) {
        ...
        long userId = 0;
        car = "https://danov-autoshow-656625355b99.herokuapp.com/showroom.html?car=" + car;
