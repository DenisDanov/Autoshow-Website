...
import com.example.app.dbData.recentlyViewedToken.RecentlyViewedRepository;
import com.example.app.dbData.recentlyViewedToken.RecentlyViewedToken;
import com.example.app.dbData.unsuccessfulLoginAttempts.ExpiringEntityDeleter;
import com.example.app.dbData.unsuccessfulLoginAttempts.FailedLoginAttempts;
import com.example.app.dbData.unsuccessfulLoginAttempts.FailedLoginAttemptsRepository;
import com.example.app.emailApp.SendGridEmailService;
...
public class LoginController {
    ...
    public String processLogin(@ModelAttribute("loginUser") User loginUser,
        ...
        if (userFromDB != null && userFromDB.getPassword().equals(loginUser.getPassword()) &&
            ...
            return "redirect:https://danov-autoshow.azurewebsites.net"; // Redirect to the home page
        } else {
            // Failed login
            if (userFromDB != null) {
